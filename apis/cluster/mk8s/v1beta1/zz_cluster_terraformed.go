...
func (mg *Cluster) GetTerraformResourceType() string {
	return "nebius_mk8s_v1_cluster"
}

// GetConnectionDetailsMapping for this Cluster
func (tr *Cluster) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"status.control_plane.auth.cluster_ca_certificate": "status.atProvider.status.controlPlane.auth.clusterCaCertificate", "status.control_plane.endpoints.private_endpoint": "status.atProvider.status.controlPlane.endpoints.privateEndpoint", "status.control_plane.endpoints.public_endpoint": "status.atProvider.status.controlPlane.endpoints.publicEndpoint"}
}
