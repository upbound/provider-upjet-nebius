...
type EgressInitParameters struct {
	...
	// Reference to a SecurityGroup in vpcv1 to populate destinationSecurityGroupId.
	// +kubebuilder:validation:Optional
	DestinationSecurityGroupIDRef *v1.Reference `json:"destinationSecurityGroupIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in vpcv1 to populate destinationSecurityGroupId.
	// +kubebuilder:validation:Optional
...
type IngressInitParameters struct {
	...
	// Reference to a SecurityGroup in vpcv1 to populate sourceSecurityGroupId.
	// +kubebuilder:validation:Optional
	SourceSecurityGroupIDRef *v1.Reference `json:"sourceSecurityGroupIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in vpcv1 to populate sourceSecurityGroupId.
	// +kubebuilder:validation:Optional
...
type SecurityRuleInitParameters struct {
	...
	// Reference to a SecurityGroup in vpcv1 to populate parentId.
	// +kubebuilder:validation:Optional
	ParentIDRef *v1.Reference `json:"parentIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in vpcv1 to populate parentId.
	// +kubebuilder:validation:Optional
