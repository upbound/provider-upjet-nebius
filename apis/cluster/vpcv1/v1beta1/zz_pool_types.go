...
type PoolInitParameters struct {
	...
	// Reference to a Pool in vpcv1 to populate sourcePoolId.
	// +kubebuilder:validation:Optional
	SourcePoolIDRef *v1.Reference `json:"sourcePoolIdRef,omitempty" tf:"-"`

	// Selector for a Pool in vpcv1 to populate sourcePoolId.
	// +kubebuilder:validation:Optional
	SourcePoolIDSelector *v1.Selector `json:"sourcePoolIdSelector,omitempty" tf:"-"`
