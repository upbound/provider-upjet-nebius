...
type EgressInitParameters struct {
	...
	DestinationSecurityGroupIDRef *v2.Reference `json:"destinationSecurityGroupIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in vpc to populate destinationSecurityGroupId.
	// +kubebuilder:validation:Optional
	DestinationSecurityGroupIDSelector *v2.Selector `json:"destinationSecurityGroupIdSelector,omitempty" tf:"-"`
}
...
type IngressInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceSecurityGroupIDRef *v2.Reference `json:"sourceSecurityGroupIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in vpc to populate sourceSecurityGroupId.
	// +kubebuilder:validation:Optional
	SourceSecurityGroupIDSelector *v2.Selector `json:"sourceSecurityGroupIdSelector,omitempty" tf:"-"`
}
