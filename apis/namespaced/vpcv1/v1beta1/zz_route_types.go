...
type NextHopAllocationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-nebius/apis/namespaced/vpcv1/v1beta1.Allocation
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("id",true)
	ID *string `json:"id,omitempty" tf:"id,omitempty"`

	// Reference to a Allocation in vpcv1 to populate id.
	// +kubebuilder:validation:Optional
	IDRef *v1.NamespacedReference `json:"idRef,omitempty" tf:"-"`

	// Selector for a Allocation in vpcv1 to populate id.
	// +kubebuilder:validation:Optional
...
type RouteInitParameters struct {
	...
	// Reference to a RouteTable in vpcv1 to populate parentId.
	// +kubebuilder:validation:Optional
	ParentIDRef *v1.NamespacedReference `json:"parentIdRef,omitempty" tf:"-"`

	// Selector for a RouteTable in vpcv1 to populate parentId.
	// +kubebuilder:validation:Optional
