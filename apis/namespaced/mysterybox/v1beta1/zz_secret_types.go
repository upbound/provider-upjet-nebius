...
type SecretObservation struct {
	...
	PrimaryVersionID *string `json:"primaryVersionId,omitempty" tf:"primary_version_id,omitempty"`
	...
	// (Attributes) :
	SecretVersion *SecretVersionObservation `json:"secretVersion,omitempty" tf:"secret_version,omitempty"`
...
type StatusObservation struct {
	...
	// (String)
	EffectiveKMSKeyID *string `json:"effectiveKmsKeyId,omitempty" tf:"effective_kms_key_id,omitempty"`
