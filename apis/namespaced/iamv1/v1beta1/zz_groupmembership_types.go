...
type GroupMembershipInitParameters struct {
	...
	// Reference to a ServiceAccount in iamv1 to populate memberId.
	// +kubebuilder:validation:Optional
	MemberIDRef *v1.NamespacedReference `json:"memberIdRef,omitempty" tf:"-"`

	// Selector for a ServiceAccount in iamv1 to populate memberId.
	// +kubebuilder:validation:Optional
	...
	// Identifier of the parent resource to which the resource belongs.
	// +crossplane:generate:reference:type=github.com/upbound/provider-nebius/apis/namespaced/iamv1/v1beta1.Group
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("id",true)
	ParentID *string `json:"parentId,omitempty" tf:"parent_id,omitempty"`

	// Reference to a Group in iamv1 to populate parentId.
	// +kubebuilder:validation:Optional
	ParentIDRef *v1.NamespacedReference `json:"parentIdRef,omitempty" tf:"-"`

	// Selector for a Group in iamv1 to populate parentId.
	// +kubebuilder:validation:Optional
