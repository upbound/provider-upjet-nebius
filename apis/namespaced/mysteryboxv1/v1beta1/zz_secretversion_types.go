...
type SecretVersionInitParameters_2 struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-nebius/apis/namespaced/mysteryboxv1/v1beta1.Secret
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("id",true)
	ParentID *string `json:"parentId,omitempty" tf:"parent_id,omitempty"`

	// Reference to a Secret in mysteryboxv1 to populate parentId.
	// +kubebuilder:validation:Optional
	ParentIDRef *v1.NamespacedReference `json:"parentIdRef,omitempty" tf:"-"`

	// Selector for a Secret in mysteryboxv1 to populate parentId.
	// +kubebuilder:validation:Optional
...
type SecretVersionPayloadInitParameters struct {
	...
	BinaryValueSecretRef *v1.LocalSecretKeySelector `json:"binaryValueSecretRef,omitempty" tf:"-"`
	...
	StringValueSecretRef *v1.LocalSecretKeySelector `json:"stringValueSecretRef,omitempty" tf:"-"`
}
