...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	for _, i := range o.Provider.Resources["nebius_mk8s_v1_cluster"].InitializerFns {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginFrameworkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["nebius_mk8s_v1_cluster"],
	...
	// register webhooks for the kind v1beta1.Cluster if they're enabled.
	if o.StartWebhooks {
