...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	for _, i := range o.Provider.Resources["nebius_compute_v1_instance"].InitializerFns {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginFrameworkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["nebius_compute_v1_instance"],
				...
				tjcontroller.WithTerraformPluginFrameworkAsyncMetricRecorder(metrics.NewMetricRecorder(v1beta1.Instance_GroupVersionKind, mgr, o.PollInterval)),
	...
	// register webhooks for the kind v1beta1.Instance if they're enabled.
	if o.StartWebhooks {
